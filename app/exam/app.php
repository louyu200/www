	...
	public function exampaper()
	{
		...
		switch($action)
		{
			...
			else
			{
				...
				{
				    //lyct
				    logger("$this->data['currentbasic']=[".$this->data['currentbasic']."]");
